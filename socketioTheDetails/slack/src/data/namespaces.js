...
const imageLinux = 'https://upload.wikimedia.org/wikipedia/commons/a/af/Tux.png'

// Set up the namespaces

let namespaces = []

let wikiNs = new Namespace(0, 'Wiki', imageWiki, '/wiki')
let mozNs = new Namespace(1, 'Mozilla', imageMozilla, '/mozilla')
let linuxNs = new Namespace(2, 'Linux', imageLinux, '/linux')
